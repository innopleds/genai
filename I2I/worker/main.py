...
from modules.generator import generate_i2i_image
from modules.schemas import I2IRequest
...
async def generate_i2i(result_image_id):
    ...
    try:
        ...
        try:
            response = await generate_i2i_image(request, result_image_id, input_image, output_dir="generated_images")
...
async def process_queue():
    while True:
        try:
            ...
            if result_image_id:
                await generate_i2i(result_image_id)
            else:
